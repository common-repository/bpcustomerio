...
class Bpcustomerio_Html_output {
                ...
                switch ($value['type']) {
                    ...
                    case 'single_select_page' :
                        ...
                        ?><tr valign="top" class="single_select_page">
                            ...
                            <td class="forminp">
                                <?php echo str_replace(' id=', " data-placeholder='" . __('Select a page&hellip;', 'paypal-ipn') . "' style='" . esc_attr( $value['css'] ) . "' class='" . esc_attr( $value['class'] ) . "' id=", wp_dropdown_pages($args)); ?> <?php echo esc_html( $description ); ?>
                            </td>
                        </tr><?php
                        break;
    ...
    public static function save_fields($options) {
        check_ajax_referer( 'bpcustomerio-ajax-nonce', 'bpcustomerio-ajax-nonce', false );
        if (empty($_POST)) {
            return false;
        }
        ...
        foreach ($options as $value) {
            ...
            if (strstr($value['id'], '[')) {
                ...
                $option_value = isset($_POST[$option_name][$setting_name]) ? stripslashes_deep(sanitize_text_field( $_POST[$option_name][$setting_name] ) ) : null;
            } else {
                $option_name = $value['id'];
                $setting_name = '';
                $option_value = isset($_POST[$value['id']]) ? stripslashes_deep( sanitize_text_field( $_POST[$value['id']] ) ) : null;
            }
